                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input required class="form-control col" type="date" name="year" id="year"
                                    placeholder="Data de nascimento" value="{{ old('year') }}">
                            </div>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <input required class="form-control" type="text" name="cpf" id="cpf"
                                    placeholder="000.000.000-00" data-mask="(00) 00000-0000"
                                    data-mask-selectonfocus="true" value="{{ old('cpf') }}">
                            </div>

                            <div class="col-md-12 mt-3">
                                <label for="name" class="form-label">WhatsApp</label>
                                <input required class="form-control" type="text" name="wpp" id="wpp"
                                    placeholder="(00) 00000-0000" data-mask="(00) 00000-0000"
                                    data-mask-selectonfocus="true" value="{{ old('wpp') }}">
                            </div>
                            <div class="col-md-6 mt-3">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#validation-success').append(
                            '<div class="alert alert-success mt-3">' + data.success + ' </div').delay(2000).fadeOut(400);
                    ...
                    error: function(xhr) {
                        ...
                        $.each(xhr.responseJSON.errors, function(key, value) {
                            $('#validation-errors').append(
                                '<div class="alert alert-danger mt-3">' + value + '</div').delay(5000).fadeOut(5000);
                        });
                        jQuery('#modal').modal('hide');
                    },
                });
